...
**This is an unofficial personal tool. Not affiliated with, endorsed by, or sponsored by Anthropic or Google.** Uses the official Claude API following Anthropic's terms of service. Uses Gemma 4 under its Apache 2.0 license.

**Not for production or organizational use** without security/compliance review. See limitations above.
...
MIT. See LICENSE file. (TODO: add LICENSE file before publishing)
